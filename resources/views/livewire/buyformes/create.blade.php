<x-jet-form-section submit="create">
    ...
    <x-slot name="form"> 
        ...
        <div class="col-span-6 sm:col-span-3">
            <x-jet-label for="name" value="{{ __('Piece') }}" />
            <x-jet-input type="text" class="mt-1 block w-full" wire:model.defer="piece" autofocus />
            <x-jet-input-error for="piece" class="mt-2" />
        </div>
        <div class="col-span-6 sm:col-span-6">
            <x-jet-label for="name" value="{{ __('Product Link') }}" />
            <x-jet-input type="text" class="mt-1 block w-full" wire:model.defer="link" autofocus />
...
{{--      
    ...
    --}}
        <div class="col-span-6 sm:col-span-6">
            <x-jet-label for="name" value="{{ __('Reference') }}" />
            <x-jet-input type="text" class="mt-1 block w-full" wire:model.defer="reference" autofocus />
    ...
    <x-slot name="actions">
        <x-back-btn-link url="buyformes.index" class="mr-2" >
            {{ __('Back') }}
        </x-back-btn-link>
