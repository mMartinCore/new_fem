...
/>
    <div class="p-4   mx-auto px-4 sm:px-4 shadow-lg rounded-lg border-2  ">      
            <div class=" flex sm:flex-row flex-col  justify-between " >
               ...
               <div class="flex flex-row mb-0   sm:mb-0" wire:loading.delay>
                    Loading...
                </div>
            ...
            <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto ">
                <div class="inline-block min-w-full shadow-lg rounded-lg overflow-hidden">
                  	<table class="w-full flex flex-row flex-no-wrap sm:bg-white rounded-lg overflow-hidden text-xs  Leading-normal"> 
                      ...
                      <tr class=" flex flex-col flex-no wrap sm:table-row rounded-l-lg sm:rounded-none mb-2 sm:mb-0">       
                        ...
                        @include('include.table.table_th',  ['field' => 'contact_title', 'label' => 'contact_title'])
                        @include('include.table.table_th',  ['field' => 'content', 'label' => 'content'])
                        {{-- @include('include.table.table_th',  ['field' => 'google', 'label' => 'google']) --}}
             ...
             <tbody class="flex-1 sm:flex-none">
                    @forelse($data as $row)
                         <tr class="flex flex-col  flex-no wrap sm:table-row mb-2 sm:mb-0">
                             ...
                             @include('include.table.table_td',  ['data' => $row->contact_title])  
                             @include('include.table.table_td',  ['data' => $row->content])  
                             {{-- @include('include.table.table_td',  ['data' => $row->google])   --}}
  ...
  <div class="flex flex-wrap mb-2 -mx-3 ">
    <div class="w-full md:w-1/2 px-3">
        <div class="mt-2">
                ...
                <x-jet-input  wire:model.lazy="email_1" id="" class="block mt-1 w-full" type="text" />
    ...
    <div class="w-full md:w-1/2 px-3">
        <div class="mt-2">
                ...
                <x-jet-input  wire:model.lazy="phone_no_1" id="" class="block mt-1 w-full" type="text" />
    ...
    <div class="w-full md:w-1/2 px-3">
        <div class="mt-2">
                <x-jet-label for="" value="{{ __('contact_title') }}" />
                <x-jet-input  wire:model.lazy="contact_title" id="" class="block mt-1 w-full" type="text" />
                @error($contact_title) <span class="error text-sm text-red-200">{{ $message }}</span> @enderror
            </div>  
    </div>
    <div class="w-full md:w-1/2 px-3">
        <div class="mt-2">
                <x-jet-label for="" value="{{ __('content') }}" />
                <x-jet-input  wire:model.lazy="content" id="" class="block mt-1 w-full" type="text" />
                @error($content) <span class="error text-sm text-red-200">{{ $message }}</span> @enderror
      </div>  
      </div>
  </div>
 ...
 {{-- TEXTAREA --}}     
      <div class="mt-4">
        <x-jet-label for="" value="{{ __('google') }}" />
        <x-textarea   wire:model.lazy="google" id="" class="block mt-1 w-full" type="text" ></x-textarea>
        @error($google) <span class="error text-sm text-red-200">{{ $message }}</span> @enderror
    </div>   
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full px-3">
      <div class="mt-4">
                ...
                <x-jet-input  wire:model.lazy="" id="" class="block mt-1 w-full" type="text" />
  ...
  <div class="flex flex-wrap -mx-3 mb-2">
    ...
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0"> 
      <div class="relative">
           <div class="mt-4">
                ...
                <select  wire:model.lazy="" id="" class="block appearance-none w-full bg-gray-100 border border-gray-200 text-gray-700 py-3 px-4 pr-8 round leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
   ...
   <div class="mt-4">
    ...
    {{-- The Delete Modal --}}
    <x-jet-dialog-modal  wire:model.lazy="modalConfirmDeleteVisible">
        <x-slot name="title">
            {{ __('Delete Record') }}
        </x-slot>
    ...
    <x-jet-dialog-modal   wire:model.lazy="modalConfirmDeleteSelectedVisible">
        <x-slot name="title">
