<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.loginsetting_bg_img') ? 'invalid' : '' }}">
        ...
        <x-dropzone id="bg_img" name="bg_img" action="{{ route('admin.loginsettings.storeMedia') }}" collection-name="loginsetting_bg_img" max-file-size="2" max-width="4096" max-height="4096" max-files="1" />
        <div class="validation-message">
    ...
    <div class="form-group">
        ...
        <a href="{{ route('admin.loginsettings.index') }}" class="btn btn-secondary">
            {{ trans('global.cancel') }}
        </a>
    </div>
</form>