...
<div class="flex items-center justify-end px-4 py-3 text-right sm:px-6">
        <x-create-btn-link url="packagestatuss.create" >
        {{ __('Create') }}
      </x-create-btn-link>
    </div>
             ...
             <tbody class="flex-1 sm:flex-none">
                    @forelse($data as $row)
                         <tr class="flex flex-col  flex-no wrap sm:table-row mb-2 sm:mb-0">
                              @include('include.table.table_td_check',  ['data' =>0])                    
                              ...
                              <td>
                                <div class="flex justify-center">
                                        <a  class ='inline-flex items-center  mr-0 px-4 py-2 bg-site_color_theme border border-transparent rounded-md font-semibold text-xs 
                                text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 
                                focus:ring focus:ring-gray-300 disabled:opacity-25 transition'href="{{ route('packagestatuss.edit', $row->id) }}">
                                        {{ __('Edit') }}
                                    </a>
                                </div>
                              </td>
