            ...
            <table class="table table-index w-full">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.loginsetting.fields.title') }}
                            @include('components.table.sort', ['field' => 'title'])
                        </th>
                        <th>
                            {{ trans('cruds.loginsetting.fields.bg_img') }}
                        </th>
                        <th>
                            {{ trans('cruds.loginsetting.fields.team') }}
                            @include('components.table.sort', ['field' => 'team.domain'])
                        </th>
                        <th>
                        </th>
                    </tr>
                ...
                <tbody>
                    @forelse($loginsettings as $loginsetting)
                        <tr>
                            <td>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    @can('loginsetting_show')
                                        <a class="btn btn-sm btn-info mr-2" href="{{ route('admin.loginsettings.show', $loginsetting) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    @can('loginsetting_edit')
                                        <a class="btn btn-sm btn-success mr-2" href="{{ route('admin.loginsettings.edit', $loginsetting) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan
                                    @can('loginsetting_delete')
