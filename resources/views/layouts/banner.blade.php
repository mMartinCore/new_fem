...
<section class="text-white body-font  trackSeach rounded-lg shadow-lg py-12 mt-4">
        <div data-aos="flip-left" data-aos-duration="2000" class="container px-8 mx-auto lg:px-4 aos-init aos-animate">
            <div class="flex flex-col w-full  text-left lg:text-center">
                <h2 class="mb-1 text-2xl font-semibold tracking-widest text-gray-100 uppercase title-font "> CONTACT </h2> 
            </div> 
        </div>
</section>