 <x-app-layout>
     ...
     @if ($user)
          <div class="max-w-8xl mx-auto sm:px-2 py-0 lg:px-4 mb-4">
             <div class="bg-gray-100 overflow-hidden   sm:rounded-md">
             <p class="text-left text-lg  px-4 text-gray-600 font-bold ">
  ...
  @empty
    <div class="w-full flex justify-center items-center">
     <p class="w-full text-center text-gray-600"></p>
...
<div class="flex justify-between items-start w-full">
                                             <div class="flex justify-center items-center lg:pr-36 space-x-4">
                                                         ...
                                                         <div
                                                             class="file-img-box pt-4 pb-6 text-center relative">
                                                              
                                                                 <span
                                                                     class="   text-white px-1 py-1 rounded 
                                            bg-red-500 px-4 w-full ">
                                                                 NO INVOICE FOUND
                                                                 </span>
                                                                 <svg xmlns="http://www.w3.org/2000/svg"
                                                                     class="object-fit text-gray-200 w-40 h-40 "
                                                                     fill="none" viewBox="0 0 24 24"
                                                                     stroke="currentColor">
                                                                     <path stroke-linecap="round"
                                                                         stroke-linejoin="round" stroke-width="2"
