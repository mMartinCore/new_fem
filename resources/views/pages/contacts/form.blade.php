...
<div class="  flex items-top justify-center min-h-screen bg-white dark:bg-gray-900 sm:items-center sm:pt-0   ">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 mb-20">
                    ...
                    <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                        ...
                        <div class="flex items-center mt-8 text-gray-600 dark:text-gray-400  mb-12">
                            ...
                            @if (isset($contact->address_1))
                              {{ $contact->address_1 ?? '  Hartlepool Enterprise Centre, Brougham Terrace, Unit 33, Hartlepool,TS248EY.'}}                                 
                            @else                                
         ...
         <div class="bg-white w-full shadow rounded p-8 sm:p-12  border-dashed border-2 border-site_color_theme">
            ...
            <form action="{{route('pages.sendMessage')}}" method="post" id="sendMessage" >
              @csrf
              
                <div class="md:flex items-center mt-4">
                    <div class="w-full md:w-1/2 flex flex-col">
                        <label class="font-semibold leading-none">Name</label>
                        <input required name="name" type="text" class="leading-none text-gray-900 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-gray-100 border rounded border-gray-200" />
                        <x-jet-input-error for="name" class="mt-2" />
                    </div>
                    <div class="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
                        <label class="font-semibold leading-none">Email</label>
                        <input required name="email" type="email" class="leading-none text-gray-900 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-gray-100 border rounded border-gray-200"/>
                ...
                <div class="md:flex items-center mt-4">
                    <div class="w-full flex flex-col">
                        ...
                        <input required name="subject" type="text" class="leading-none text-gray-900 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-gray-100 border rounded border-gray-200"/>
                ...
                <div>
                    <div class="w-full flex flex-col mt-4">
                        ...
                        <textarea required name="message" type="text" class="h-40 text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-blue-700 mt-4 bg-gray-100 border rounded border-gray-200"></textarea>
                        <x-jet-input-error for="message" class="mt-2" />
                    </div>
                </div>
                <div class="flex items-center justify-center w-full">
                    <button id="submit" class="mt-9 font-semibold leading-none text-white py-4 px-10 bg-site_color_theme rounded hover:bg-site_color_hover focus:ring-2 focus:ring-offset-2 focus:ring-blue-700 focus:outline-none">
                        Send message
                    </button>
                </div>
            </form>
...
var subdomain =  window.location.host.split('.')[2] ? window.location.host.split('.')[0] : false;
//var subdomain =  window.location.host.split('.')[1] ? window.location.host.split('.')[0] : false;
if(!subdomain){
    //DISPALY THE MODAL TO SELECT BRANCH WHEN THE USER DOES NOT SELECT A BRANCH  
    message.innerHTML = 'Please select a branch to send your message and return to this page';  
